...
```
Use the command `npm start` to start you server with the Typescript auto compilation and the nodemon task. Nodemon restart automatically your server when a file is modified.